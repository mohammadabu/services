...
class ReportservicesTaskUser(models.Model):
    _name = "report.services.task.user"
    _description = "Tasks Analysis"
    _order = 'name desc, services_id'
    _auto = False
    ...
    services_id = fields.Many2one('services.services', string='services', readonly=True)
    ...
    stage_id = fields.Many2one('services.task.type', string='Stage', readonly=True)
