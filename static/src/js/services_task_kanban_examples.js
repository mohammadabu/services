odoo.define('services.task_kanban_examples', function (require) {
'use strict';
...
kanbanExamplesRegistry.add('services', {
    ...
    examples:[{
        ...
        name: _lt('Consulting'),
        columns: [_lt('New servicess'), _lt('Resources Allocation'), _lt('In Progress'), _lt('Done')],
        description: escFormat(_lt('Manage the lifecycle of your services using the kanban view. Add newly acquired services, assign them and use the %s and %s to define if the services is ready for the next step.'), greenBullet, redBullet),
        bullets: [greenBullet, redBullet],
    }, {
        name: _lt('Research services'),
        columns: [_lt('Brainstorm'), _lt('Research'), _lt('Draft'), _lt('Final Document')],
        description: escFormat(_lt('Handle your idea gathering within Tasks of your new services and discuss them in the chatter of the tasks. Use the %s and %s to signalize what is the current status of your Idea'), greenBullet, redBullet),
        bullets: [greenBullet, redBullet],
    }, {
