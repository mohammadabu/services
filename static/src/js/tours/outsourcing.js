odoo.define('services.tour', function(require) {
"use strict";
...
tour.register('services_tour', {
    url: "/web",
}, [tour.STEPS.SHOW_APPS_MENU_ITEM, {
    trigger: '.o_app[data-menu-xmlid="services.menu_main_pm"]',
    content: _t('Want a better way to <b>manage your servicess</b>? <i>It starts here.</i>'),
    position: 'right',
    edition: 'community',
}, {
    trigger: '.o_app[data-menu-xmlid="services.menu_main_pm"]',
    ...
    extra_trigger: '.o_services_kanban',
    content: _t('Let\'s create your first services.'),
    position: 'bottom',
    width: 200,
}, {
    trigger: 'input.o_services_name',
    content: _t('Choose a <b>services name</b>. (e.g. Website Launch, Product Development, Office Party, etc.)'),
    position: 'right',
}, {
    trigger: '.o_open_tasks',
    content: _t('This will create a new services and redirect us to its stages.'),
    position: 'top',
    run: function (actions) {
        actions.auto('.modal:visible .btn.btn-primary');
    },
}, {
    trigger: ".o_kanban_services_tasks .o_column_quick_create input",
    content: _t("Add columns to configure <b>stages for your tasks</b>.<br/><i>e.g. New - In Progress - Done</i>"),
    position: "bottom",
}, {
    trigger: ".o_kanban_services_tasks .o_column_quick_create .o_kanban_add",
    auto: true,
}, {
    trigger: ".o_kanban_services_tasks .o_column_quick_create input",
    content: _t("Add columns to configure <b>stages for your tasks</b>.<br/><i>e.g. New - In Progress - Done</i>"),
    ...
    trigger: '.o-kanban-button-new',
    extra_trigger: '.o_kanban_services_tasks',
    ...
    extra_trigger: '.o_form_services_tasks.o_form_readonly',
